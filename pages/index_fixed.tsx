...
<div class="guide" id="guide">
  ...
  <div id="step2" class="step">
    ...
    <img src="/Open Shopify Code Editor.png" alt="Open Shopify Code Editor" style="width: 100%; border-radius: 8px; margin: 10px 0;" />
  ...
  <div id="step3" class="step">
    ...
    <img src="/Add Snippet – \`video-intro.liquid\` step 2.png" alt="Add Snippet – video-intro.liquid" style="width: 100%; border-radius: 8px; margin: 10px 0;" />
  ...
  <div id="step4" class="step">
    ...
    <img src="/Update \`settings_schema.json\`.png" alt="Update settings_schema.json" style="width: 100%; border-radius: 8px; margin: 10px 0;" />
  ...
  <div id="step5" class="step">
    ...
    <img src="/Embed Snippet in \`theme.liquid\`.png" alt="Embed Snippet in theme.liquid" style="width: 100%; border-radius: 8px; margin: 10px 0;" />
  ...
  <div id="step6" class="step">
    ...
    <img src="/Customize Settings.png" alt="Customize Settings" style="width: 10%; border-radius: 8px; margin: 10px auto; display: block;" />
